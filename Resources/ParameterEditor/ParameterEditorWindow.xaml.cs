...
namespace Lesse.LoadRunner.ParameterEditor {
    ...
    public partial class ParameterEditorWindow : Window {
        ...
        /// <summary>
        /// Display "
            Name " comboBox button when checked.
        /// </summary>
        ...
        /// <summary>
        /// Displays "
            Index " comboBox button when checked.
        /// </summary>
        ...
        /// <summary>
        /// Sets current List"
            Scenario " object. Used for script parameterization.
        /// </summary>
        /// <param name="
            scenarios ">Object to be used.</param>
        ...
        private void loadParameterizeInformation(Scenario scenario)
        {
            ...
            item.Image.Source = new BitmapImage(new Uri(@"
            pack: //application:,,,/PerformanceTool;component/Images/ParameterEditor/Gnome-Folder-Visiting-32.png"));
        ...
        public void writeAsText (TextWriter writer, ScriptParameterizationData data, String itemName) {
            ...
            writer.WriteLine (@"ParamName="
                "{0}"
                "", itemName);
            writer.WriteLine (@"TableLocation="
                "Local"
                "");
            ...
            writer.WriteLine (@"Table="
                "{0}"
                "", data.Table);
            writer.WriteLine (@"GenerateNewVal="
                "{0}"
                "", data.GenerateNewValue);
            writer.WriteLine (@"Type="
                "{0}"
                "", data.Type);
            writer.WriteLine (@"value_for_each_vuser="
                "{0}"
                "", data.ValueForEachVirtualUser);
            writer.WriteLine (@"OriginalValue="
                "{0}"
                "", data.OriginalValue);
            writer.WriteLine (@"auto_allocate_block_size="
                "{0}"
                "", data.AutoAllocateBlockSize);
            writer.WriteLine (@"SelectNextRow="
                "{0}"
                "", data.SelectNextRow);
            writer.WriteLine (@"StartRow="
                "{0}"
                "", data.StartRow);
            writer.WriteLine (@"OutOfRangePolicy="
                "{0}"
                "", data.OutOfRangePolicy);
        }
